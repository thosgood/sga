...
As a matter of fact, there are also corresponding comments to make about local homomorphisms (without the finiteness condition), which in any case should appear in the \marginpar{\small[Trans.] Grothendieck's \emph{multiplodoque d'algèbre homologique} was the final version of his \emph{Tohoku paper} — see (2.1) in `Life and work of Alexander Grothendieck' by Ching-Li Chan and Frans Oort for more information.}multiplodoque (starting with the case of unramified).
