...
::: {.itenv #I.6.2 title="Corollary 6.2"}
...
::: {.proof}
We can reduce to the case where $A$ is Artinian (by replacing $A$ by $A/\frak{m}^n$), and then this is a particular case of [5.5]{#I.5.5}.
