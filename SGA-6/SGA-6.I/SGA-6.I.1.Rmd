...
Let $\cal{S}$ be a category, and let $\cal{C}$ be a fibred $\cal{S}$-category (SGA 1 VI 6.1) with additive (resp. triangulated) fibres.
...
We define, using a cleavage of $\cal{C}$ (SGA 1 VI 7.1), for example, a fibred $\cal{S}$ category $\operatorname{Tr}(\cal{C})$ whose fibre at each $X\in\ob(\cal{S})$ is the category $\operatorname{Tr}(\cal{C}_X)$ of distinguished triangles of $\cal{C}_X$.
:::
